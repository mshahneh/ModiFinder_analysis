...
from benchmark_cmfid import calculate_probabilities
...
def main(id_known, id_modified, method, args, output, data_path):
    ...
    file_name = id_known + "_" + id_modified + ".txt"
    try:
        probabilities = calculate_probabilities(known_compond, modified_compond, file_name, data_path)
    except:
        probabilities = [0 for i in range(known_compond.structure.GetNumAtoms())]
    ...
    data["cosine_true_site"] = probabilities[true_site]
...
# python runner_random.py --experiment_id "d735eede6567b2832a2ca6ed0849394557b8dccc" --experiments_metadata "/home/user/Substructure_Assignment/my_implementation/SmallMol_Mod_Site_Localization_Analysis/results/experiments_meta.csv" --output "/home/user/Substructure_Assignment/my_implementation/SmallMol_Mod_Site_Localization_Analysis/results/test.json" --id_known "CCMSLIB00005464138" --id_modified "CCMSLIB00005464351"
